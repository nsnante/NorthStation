...
#define CITIZENSHIP_FEDERATION "The Federation"
#define CITIZENSHIP_ALPHA_CENTAURI "Centauri Free Territories"
...
#define CITIZENSHIP_PR_SLOGOTH "People's Republic of Slogoth"

#define CITIZENSHIP_FREEBOOTER "The Freebooters"
...
#define RELIGIONS_FEDERATION list(RELIGION_NONE, RELIGION_CHRISTIANITY, RELIGION_ISLAM, RELIGION_BUDDHISM, RELIGION_SHINTO, RELIGION_HINDU, RELIGION_TAOISM, RELIGION_JUDAISM, RELIGION_SIKHISM, RELIGION_OTHER, RELIGION_TRINARY)
#define CITIZENSHIPS_FEDERATION list(CITIZENSHIP_FEDERATION)
...
CITIZENSHIP_NONE, CITIZENSHIP_GOLDEN, CITIZENSHIP_CONSORTIUM, CITIZENSHIP_GLAORR, CITIZENSHIP_EKANE, CITIZENSHIP_FEDERATION,\
CITIZENSHIP_ALPHA_CENTAURI, CITIZENSHIP_PR_SLOGOTH, CITIZENSHIP_FREEBOOTER)
